...
namespace GamesMy
{
    public class Room : IInventory
    {
        ...
        public override string ToString()
        {
            ...
            if (Visited)
                sb.Append(string.Format(Text.Language.OldRoom, Name));
            else
                sb.Append(string.Format(Text.Language.NewRoom, Name));
            ...
            var description = string.Format(Description, Text.Language.JoinWorldList(directions, Text.Language.And));
            ...
            { 
                ...
                sb.Append(string.Format(Text.Language.TotalItems, pluralPre,
                    items.Length, pluralPost));
                sb.Append(Text.Language.JoinWorldList(items, Text.Language.And) + Text.Language.Period);
            }
